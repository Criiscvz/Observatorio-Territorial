...
@Component({
  ...
  template: `
    ...
    <section class="hero">
      ...
      <div class="hero-content">
        <h1 class="hero-title">
          <span class="hero-highlight">Observatorio</span> de Datos
          <br>Universitarios ULEAM
        </h1>
        <p class="hero-subtitle">
          Transforma tus archivos Excel en dashboards interactivos de manera automática.
          Analiza, visualiza y comparte datos de forma inteligente.
        </p>
        <div class="hero-actions">
          <a mat-raised-button color="primary" routerLink="/publico/departamentos" class="hero-btn primary">
  ...
  styles: [`
    ...
    :host-context(.dark) .hero-bg {
      background: linear-gradient(135deg, rgba(99, 102, 241, 0.1) 0%, var(--bg-primary) 50%, var(--bg-secondary) 100%);
    }
    ...
    .card-1 { top: 0; right: 100px; animation-delay: 0s; }
    .card-2 { top: 120px; right: 0; animation-delay: 0.5s; }
    .card-3 { top: 240px; right: 80px; animation-delay: 1s; }
    ...
    .loading-container, .empty-departments {
      text-align: center;
      padding: 3rem;
      color: var(--text-secondary);
    }
